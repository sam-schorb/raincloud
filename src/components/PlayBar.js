...
function PlayBar({ setNotificationType }) {
    ...
    return (
<div key={playingPatch} className="fixed bottom-0 w-full h-18 bg-vdark-gray grid grid-cols-11 items-center p-4 transition-transform transform duration-500 z-40">
